...
public class FormularioAlunoActivity extends AppCompatActivity {
    ...
    private void preencheCamposTelefone() {
        new BuscaTodosTelefonesAlunoTask(telefoneDAO, aluno, telefonesEncontrados -> {
    ...
    private void salvaAluno(Telefone telefoneFixo, Telefone telefoneCelular) {
        ...
        new SalvaAlunoTask(
                alunoDAO, aluno, telefoneFixo, telefoneCelular, telefoneDAO, this::finish)
                .execute();
    }

    private void editaAluno(Telefone telefoneFixo, Telefone telefoneCelular) {
        new EditaAlunoTask(alunoDAO, aluno, telefoneCelular, telefoneFixo, telefoneDAO, telefones,
                this::finish).execute();
    }
